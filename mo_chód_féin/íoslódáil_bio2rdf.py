...
prefs = {"download.default_directory" : "E:\\Tráchtas\\Downloading\\" + fillteán + "\\"}
...
chun_íoslódáil = [nasc for nasc in nascanna if '.nq' in nasc.text][:332]
méid_grúpaí = 10
grúpaí = [chun_íoslódáil[i:i+méid_grúpaí] for i in range(0, len(chun_íoslódáil), méid_grúpaí)]
for grúpa in grúpaí:
    for réad in grúpa:
        réad.click()
    time.sleep(180) #5 nóiméad chun gach grúpa a íoslódáil
